...
const loginC = async (req, res) => {
    ...
    try {
        ...
        const result = await pool
            ...
            .query("SELECT username, mobileno, emailID, passwordHash FROM Users WHERE username = @username or mobileno = @username");
            ...
            if (validPassword) {
                ...
                res.status(200).json({
                    ...
                    user: {
                        ...
                        emailID: user.emailID // Ensure emailID is included here
                    }
                });
            } else {
